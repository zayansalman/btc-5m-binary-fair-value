...
from btc_5m_exec.core.types import BuyOpportunity as BuyOpportunityNew
from btc_5m_exec.strategy.pricing_model import fair_up_probability, sigma_per_second
from btc_5m_exec.strategy.sizing import confidence_from_edge
...
class BinanceWindowCache:
    ...
    def __init__(self, cache_dir: Path | None = None) -> None:
        if cache_dir is None:
            cache_dir = Path.home() / ".btc_5m_exec" / "backtests" / "binance_1s"
...
def evaluate_params(
    ...
    from btc_5m_exec.core.types import StrategyParams
    from btc_5m_exec.strategy.sizing import notional_from_confidence
