...
class AbstractPriceConnector(ABC):
    ...
    async def get_spot_and_recent_closes(self) -> tuple[float, list[float]]:
        ...
        :func:`btc_5m_exec.strategy.pricing_model.sigma_per_second`.
        """
        ...
...
class AbstractSignalGenerator(ABC):
    """Given market data, produce a :class:`~btc_5m_exec.core.types.Signal`."""
    ...
    def generate(
        ...
        Returns:
            A fully populated :class:`~btc_5m_exec.core.types.Signal`.
        """
        ...
