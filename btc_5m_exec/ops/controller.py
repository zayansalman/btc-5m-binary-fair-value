...
from btc_5m_exec.connectors.registry import ConnectorRegistry
...
log = logging.getLogger("btc_5m_exec.controller")
...
class BotController:
    ...
    async def _close_position(
        ...
        from btc_5m_exec.execution.paper import _pnl_for_position, _current_price_for_tick
