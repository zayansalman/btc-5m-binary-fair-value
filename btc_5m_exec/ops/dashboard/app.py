...
from btc_5m_exec.ops.dashboard.ems import ems_html  # type: ignore[import-untyped]
...
try:
    ...
    from btc_5m_exec.execution.live import (  # type: ignore[import-untyped]
        LiveBootRefused,
...
async def _lifespan(app: FastAPI):
    ...
    from btc_5m_exec.execution.gate import migrate_clear_stale_bypass_v76
...
async def api_loss_halt_reset() -> dict[str, Any]:
    ...
    from btc_5m_exec.execution.gate import reset_daily_loss_halt
...
async def api_runtime_config(request: Request) -> dict[str, Any]:
    ...
    """
    from db import notify  # type: ignore[import-untyped]
    from btc_5m_exec.execution.gate import set_runtime_max_trade_usd
    ...
    if key == "trade_shares":
        from btc_5m_exec.execution.gate import set_runtime_trade_shares
        from btc_5m_exec.execution.live import DEFAULT_MIN_ORDER_SIZE
...
def launch() -> None:
    ...
    import uvicorn
    uvicorn.run(
        "btc_5m_exec.ops.dashboard.app:app",
