...
``btc_5m_exec/ops/dashboard/panels/``. Each panel is a pure (data, context) →
...
from btc_5m_exec.ops.dashboard.panels import _data as data
from btc_5m_exec.ops.dashboard.panels import (
    blotter,
    controls,
    decision_engine,
    guardrails,
