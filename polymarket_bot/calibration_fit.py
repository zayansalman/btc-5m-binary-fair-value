...
Run::
    ...
    python -m polymarket_bot.calibration_fit          # fit on all closed clob trades
    python -m polymarket_bot.calibration_fit --min 20 # require at least 20 samples
    python -m polymarket_bot.calibration_fit --style settle  # restrict to one style
    python -m polymarket_bot.calibration_fit --dry-run       # print, do not persist
...
from polymarket_bot.calibration import IsotonicCalibrator, save
